...
class FiltersPrefsInteractorImpl(
    ...
    override fun saveFilters(industryId: String?, industryName: String?, salary: Int?, hide: Boolean) {
        filtersPrefsRepository.saveFilters(industryId, industryName, salary, hide)
    }
